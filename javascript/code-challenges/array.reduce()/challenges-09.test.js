...
const hasChildrenValues = (arr, character) => {
  // Solution code here...
  //step 1: find the specific character in bucket (array)
...
//   if (characterObject.name === character) {
//     //step 2: check whether they have children
//     console.log("working", characterObject.name);
//     console.log(characterObject.children);
//     if (characterObject.children && characterObject.children.length > 0) {
//       //step 3: return true if they do have children or false for no children
//       return true;
//     } else {
//       return false;
//     }
